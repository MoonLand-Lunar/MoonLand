...
function blockchain_lite_get_social_networks() {
	return apply_filters( 'blockchain_lite_social_networks', array(
		...
		array(
			'name'  => 'tiktok',
			'label' => esc_html__( 'TikTok', 'blockchain-lite' ),
			'icon'  => 'fab fa-tiktok',
		),
		array(
			'name'  => 'telegram',
...
if ( ! function_exists( 'blockchain_lite_scripts_styles_suffix' ) ) {
	function blockchain_lite_scripts_styles_suffix() {
		$suffix = '.min';
		...
		return apply_filters( 'blockchain_lite_scripts_styles_suffix', $suffix );
	}
}

add_filter( 'stylesheet_uri', 'blockchain_lite_stylesheet_uri', 10, 2 );
if ( ! function_exists( 'blockchain_lite_stylesheet_uri' ) ) {
	function blockchain_lite_stylesheet_uri( $stylesheet_uri, $stylesheet_dir_uri ) {
		if ( ! is_child_theme() ) {
