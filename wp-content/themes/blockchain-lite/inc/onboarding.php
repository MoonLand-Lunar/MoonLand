...
function blockchain_lite_get_theme_recommended_plugins() {
	return apply_filters( 'blockchain_lite_theme_recommended_plugins', array(
		...
		'contact-form-7'        => array(
			'title'              => __( 'Contact Form 7', 'blockchain-lite' ),
			'description'        => __( 'Just another contact form plugin. Simple but flexible.', 'blockchain-lite' ),
...
function blockchain_lite_onboarding_page_init() {
	...
	require_once get_theme_file_path( '/inc/onboarding/class-onboarding-page-lite.php' );
