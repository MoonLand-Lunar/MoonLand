	...
	class cryptoairdrop_Customize_Homepage_Roadmap extends cryptoairdrop_Customize_Base_Option {
		...
		public function elements() {
			...
			return array(
				...
				// RoadMap Progress
				'cryptoairdrop_roadmap_progress' => array(
					'setting' => array(
						'default'           => array(
							'slider' => 75,
							'suffix' => '',
						),
						'sanitize_callback' => array( 'cryptoairdrop_Customizer_Sanitize', 'sanitize_slider' ),
					),
					'control' => array(
						'type'        => 'slider',
						'priority'    => 33,
						'label'       => esc_html__( 'Roadmap Progress', 'cryptoairdrop' ),
						'section'     => 'cryptoairdrop_theme_roadmap',
						'input_attrs' => array(
							'min'  => 15,
							'max'  => 200,
