...
function wpfrank_cryptoairdrop_frontpage_sections_settings( $wp_customize ){
	...
	/* Roadmap Settings */
	 $wp_customize->add_section( 'cryptoairdrop_theme_roadmap' , array(
		...
		if ( class_exists( 'cryptoairdrop_Repeater' ) ) {
			...
			$wp_customize, 'cryptoairdrop_roadmap_content', array(
	...
	/* Docs Settings */
	 $wp_customize->add_section( 'cryptoairdrop_theme_docs' , array(
		...
		if ( class_exists( 'cryptoairdrop_Repeater' ) ) {
			...
			$wp_customize->add_control( new cryptoairdrop_Repeater( 
			$wp_customize, 'cryptoairdrop_docs_content', array(
